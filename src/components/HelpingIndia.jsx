...
//   return (
//     <section className="bg-[#fff8f1] py-12 px-4 sm:px-6 md:px-12 lg:px-20">
...
//           <div
//             ref={scrollRef}
//             className="h-[420px] overflow-hidden space-y-6 px-1"
//           >
//             {[...testimonials, ...testimonials].map((t, i) => (
//               <div
//                 key={i}
//                 className="bg-white p-5 rounded-2xl shadow-md transition-transform group border border-[#f0d9eb]"
//               >
