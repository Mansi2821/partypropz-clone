// src/components/BestsellersMore.js
...
// const categories = ['Best Seller', 'New Arrival', 'Top Rated'];

// const BestsellersMore = () => {
//   const [activeCat, setActiveCat] = useState('Best Seller');

//   return (
//     <section className="px-4 md:px-12 py-10 bg-[#fdf6ef]">
//       <div className="text-center mb-6">
//         <h3 className="text-2xl md:text-3xl font-bold text-[#9c3587] mb-2">
//           ✨ Bestsellers & More ✨
//         </h3>
//         <p className="text-base text-[#9c3587]">Our Most‑Loved, Just for You!</p>
//       </div>
...
//               activeCat === cat
//                 ? 'bg-[#9c3587] text-white shadow-lg'
...
//           <div
//             key={p.id}
//             className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 group cursor-pointer overflow-hidden"
//           >
...
//             <div className="p-4 flex flex-col flex-grow bg-[#fdf6ef]">
//               <h4 className="text-[#9c3587] font-semibold text-base mb-2 line-clamp-2">
//                 {p.name}
//               </h4>
//               <div className="flex items-center justify-between mt-auto">
//                 <span className="text-[#9c3587] font-bold text-lg">₹{p.price}</span>
//                 <button className="bg-[#9c3587] hover:bg-[#ff3366] text-white font-medium py-2 px-4 rounded-full transition-transform duration-300 group-hover:scale-105 text-sm">
//                   Add to Cart
//                 </button>
//               </div>
//             </div>
...
const BestsellersMore = () => {
  ...
  return (
    <section className="px-4 md:px-12 py-10 bg-[#fdf6ef]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((p) => (
          <div key={p.id} className="group bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300 overflow-hidden cursor-pointer">
            {/* Image Container */}
            ...
            {/* Info */}
            <div className="p-4 bg-[#fdf6ef] flex flex-col">
